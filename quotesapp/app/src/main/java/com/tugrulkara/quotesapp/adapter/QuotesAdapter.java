...
public class QuotesAdapter extends RecyclerView.Adapter<QuotesAdapter.PostHolder> implements Filterable {
    ...
    private QuotesAdapter.OnItemClickListener quoteListener;
    private QuotesAdapter.OnItemClickListener quoteMakerListener;
    ...
    public void setOnQuoteClickListener(QuotesAdapter.OnItemClickListener listener){
        quoteListener=listener;
    }

    public void setOnQuoteMakerClickListener(QuotesAdapter.OnItemClickListener listener){
    ...
    public QuotesAdapter(List<Quote> quotesList,List<Quote> quoteListFull,Context mContext) {
