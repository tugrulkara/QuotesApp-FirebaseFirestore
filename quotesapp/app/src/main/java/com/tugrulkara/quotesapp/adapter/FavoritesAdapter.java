...
public class FavoritesAdapter extends RecyclerView.Adapter<FavoritesAdapter.PostHolder>{
    ...
    private FavoritesAdapter.OnItemClickListener quoteListener;
    private FavoritesAdapter.OnItemClickListener quoteMakerListener;

    public interface OnItemClickListener {
        void onItemClick(int position,View view);
    }

    public void setOnQuoteClickListener(FavoritesAdapter.OnItemClickListener listener){
        quoteListener=listener;
    }

    public void setOnQuoteMakerClickListener(FavoritesAdapter.OnItemClickListener listener){
